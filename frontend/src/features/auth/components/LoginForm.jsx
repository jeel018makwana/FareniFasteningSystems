        ...
        <div className="relative z-10 flex min-h-screen flex-col justify-between p-12 xl:p-16">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex h-12 w-12 items-center justify-center border-2 border-orange-500 bg-black">
              ...
              <div>
                ...
                <p className="text-[11px] font-semibold tracking-[0.35em] text-gray-400">
